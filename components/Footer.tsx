 ...
 *
 * PURPOSE:
 * Global footer providing company information, navigation links, and contact details.
 * Consistent across all pages with comprehensive business information.
 *
 * FEATURES:
 * - Four-column responsive layout (1 col mobile, 4 cols desktop)
 ...
 * - Primary navigation backup
 * - Business credibility and contact
 *
 * DESIGN:
 * - Light cream background (#F8F8F5)
 * - Navy text (#0D1B2A) for readability
 * - Gold brand accents (#FFD700)
