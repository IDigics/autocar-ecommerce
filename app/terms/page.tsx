...
export default function TermsOfUse() {
  ...
  const heroData = {
    ...
    description: "Découvrez les conditions qui régissent l'utilisation des services AutoCar'z et nos engagements mutuels.",
    icon: "📋",
    features: [
  ...
  return (
    <PageLayout hero={heroData}>
      ...
      {activeSection === "acceptance" && (
        <div className="grid lg:grid-cols-2 gap-8">
          <ContentSection title="Acceptation des Conditions" icon="📋">
            <p>
              En utilisant les services d'AutoCar'z, vous acceptez d'être lié par les 
              présentes conditions d'utilisation. Si vous n'acceptez pas ces conditions, 
              veuillez ne pas utiliser nos services.
            </p>
            <p>
              Ces conditions constituent un contrat juridiquement contraignant entre vous 
              et AutoCar'z. Elles peuvent être mises à jour périodiquement, et nous vous 
              encourageons à les consulter régulièrement.
            </p>
          </ContentSection>
      ...
      {activeSection === "services" && (
        <div>
          <ContentSection title="Description des Services" icon="🚗" className="mb-8">
            <p>
              AutoCar'z propose une gamme complète de services automobiles premium, 
              de la vente de véhicules neufs et d'occasion aux solutions de financement 
      ...
      {activeSection === "obligations" && (
        <div>
          <ContentSection title="Obligations du Client" icon="📝" className="mb-8">
            <p>
              En tant que client d'AutoCar'z, vous vous engagez à respecter certaines 
              obligations pour garantir le bon déroulement de nos services et maintenir 
      ...
      {activeSection === "warranties" && (
        <div>
          <ContentSection title="Garanties et Services" icon="🛡️" className="mb-8">
            <p>
              AutoCar'z s'engage à vous fournir des véhicules de qualité accompagnés 
              de garanties complètes et de services après-vente exceptionnels.
            </p>
          </ContentSection>
          ...
          <div className="mt-8 bg-gradient-to-r from-[#FFD700]/10 to-[#E6B800]/10 border border-[#FFD700]/20 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="font-bold text-[#0D1B2A] text-lg">Engagement Qualité</h4>
            </div>
            <p className="text-[#71797E]">
              Tous nos véhicules sont soigneusement sélectionnés et contrôlés par nos experts. 
              Nous garantissons la transparence totale sur l'état et l'historique de chaque véhicule.
            </p>
          </div>
        </div>
      )}
      ...
      {activeSection === "liability" && (
        <div className="grid lg:grid-cols-2 gap-8">
          <ContentSection title="Limitation de Responsabilité" icon="⚖️">
            <p>
              AutoCar'z s'efforce de fournir des services de qualité, mais certaines 
              limitations de responsabilité s'appliquent dans le cadre légal en vigueur.
            </p>
          ...
          <ContentSection title="Résolution des Litiges" icon="🤝">
            <p>
              ...
              les tribunaux français sont compétents selon les conditions prévues par la loi.
            </p>
            <div className="mt-4 p-4 bg-[#F8F8F5] rounded-lg">
              ...
              <p className="text-sm text-[#71797E]">
                Vous pouvez recourir à une médiation avant toute action judiciaire. 
