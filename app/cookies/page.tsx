...
export default function CookiePolicy() {
  const heroData = {
    ...
    description: "Informations sur l'utilisation des cookies sur le site AutoCar'z et comment les gérer dans votre navigateur.",
    icon: "🍪",
    features: [
  ...
  const browserSettings = [
    {
      icon: "🌐",
      title: "Chrome",
      description: "Paramètres > Confidentialité et sécurité > Cookies et autres données de sites"
    },
    {
      icon: "🦊",
      title: "Firefox", 
      description: "Paramètres > Vie privée et sécurité > Cookies et données de sites"
    },
    {
      icon: "🧭",
      title: "Safari",
      description: "Préférences > Confidentialité > Gérer les données de sites web"
    },
    {
      icon: "🔷",
      title: "Edge",
  ...
  const thirdPartyInfo = [
    {
      ...
      description: "Analyse du trafic et du comportement des utilisateurs - policies.google.com"
    },
    {
      icon: "📘",
    ...
    },
    {
      icon: "🔥",
      title: "Hotjar",
      description: "Enregistrements de session et cartes de chaleur - hotjar.com/privacy"
    }
  ];
  ...
  return (
    <PageLayout hero={heroData}>
      <div className="grid lg:grid-cols-2 gap-8 mb-8">
        <ContentSection title="Qu'est-ce qu'un Cookie ?" icon="🍪">
          ...
          <div className="mt-6 p-4 bg-[#FFD700]/10 border border-[#FFD700]/20 rounded-lg">
            <h5 className="font-semibold text-[#0D1B2A] mb-2">📝 Note Importante</h5>
        ...
        <ContentSection title="Pourquoi Utilisons-nous des Cookies ?" icon="🎯">
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <div>
                <strong>Fonctionnement du site :</strong> Pour maintenir votre session et assurer la sécurité
              </div>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-2 h-2 bg-[#FFD700] rounded-full mt-2"></span>
              <div>
                <strong>Amélioration de l'expérience :</strong> Pour mémoriser vos préférences
              </div>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-2 h-2 bg-[#FFD700] rounded-full mt-2"></span>
              <div>
                <strong>Analyse du trafic :</strong> Pour comprendre comment vous utilisez le site
              </div>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-2 h-2 bg-[#FFD700] rounded-full mt-2"></span>
              <div>
                <strong>Publicité pertinente :</strong> Pour vous proposer des offres adaptées
              </div>
            </li>
          </ul>
        </ContentSection>
      ...
      <ContentSection title="Types de Cookies Utilisés" icon="📋" className="mb-8">
        <p className="mb-6">
          Voici les différents types de cookies que nous utilisons sur notre site :
        </p>
      </ContentSection>
        ...
        <ContentSection title="Comment Gérer les Cookies ?" icon="⚙️">
            ...
            {browserSettings.map((browser, index) => (
              <div key={index} className="bg-[#F8F8F5] p-3 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-semibold text-[#0D1B2A]">{browser.title}</span>
                </div>
          ...
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-sm text-amber-800">
              ⚠️ <strong>Attention :</strong> Désactiver certains cookies peut affecter 
        ...
        <ContentSection title="Services Tiers" icon="🔗">
            ...
            {thirdPartyInfo.map((service, index) => (
              <div key={index} className="bg-[#F8F8F5] p-3 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-semibold text-[#0D1B2A]">{service.title}</span>
                </div>
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              💡 <strong>Conseil :</strong> Consultez les politiques de confidentialité 
              de ces services pour plus d'informations.
            </p>
          </div>
        </ContentSection>
      </div>
      ...
      <div className="mt-8 bg-gradient-to-r from-[#FFD700]/10 to-[#E6B800]/10 border border-[#FFD700]/20 rounded-xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="font-bold text-[#0D1B2A] text-lg">Mise à Jour de cette Politique</h4>
        </div>
